...
\title[Transparencia en Investigación] % (optional, use only with long paper titles)
...
{MIES, Octubre 2018\\
Slides disponibles en \\ \url{https://tinyurl.com/yca6bzw2}}
...
``Un plan de pre-análisis (PAPs) es una \textbf{descripción detallada de los análisis a ser conducidos}. Esta descripción es escrita antes de ver los datos que contienen los impactos del programa bajo evaluación. Puede especificar las \textbf{hipótesis a testear, como se construirán las variables, ecuaciones a estimar, controles a utilizar, y otros aspectos del análisis}. Una función clave de los PAPs es incrementar la transparencia en investigación. Al \textbf{especificar los detalles por adelantado antes de ver los resultados}, el plan es un resguardo contra data mining y búsqueda de especificaciones. Se les recomienda a los investigadores que desarrollen y suban dichos planes junto con el registro de sus estudios. Sin embargo, esto no es requisito para el registro de un estudio.''
\end{frame}
...
Conocidas como Reportes Registrados, cambia momento de peer review hacia antes del la recolección de dates, análisis y resultados. 
...
\end{enumerate}
\href{https://osf.io/8mpji/wiki/home/}{+100 Journals  \beamergotobutton{Link}}
\end{frame}
